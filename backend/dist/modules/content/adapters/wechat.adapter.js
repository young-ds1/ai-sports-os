 ...
 * - 封面图 prompt 单独生成
 */
let WechatAdapter = class WechatAdapter {
    platform = 'wechat';
    maxLength = 2000;
    bestTimeUTC = '12:30'; // 北京时间 20:30
    format = 'markdown';
    ...
    extractKeyInsight(text) {
        ...
        const insight = lines.find(l => /\d+/.test(l) && (l.includes('表现') || l.includes('关键') || l.includes('数据') || l.includes('战术')));
        if (insight) {
...
exports.WechatAdapter = WechatAdapter = __decorate([
