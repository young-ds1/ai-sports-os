...
exports.HookOptimizerService = void 0;
const common_1 = require("@nestjs/common");
let HookOptimizerService = class HookOptimizerService {
     ...
     */
    getBestForPlatform(platform, limit = 3) {
        return [...this.patterns]
    ...
    enhance(platform, body, signal) {
        ...
        if (bestPatterns.length > 0) {
            ...
            if (pattern.id === 'numbers-first' && !/^\d/.test(body.trim())) {
                const totalGoals = signal?.matchData?.totalGoals;
     ...
     */
    recordEngagement(patternId, metrics) {
        ...
        pattern.avgEngagement = Math.round(pattern.avgEngagement * (1 - alpha) + metrics.engagement * alpha);
        pattern.useCount++;
...
exports.HookOptimizerService = HookOptimizerService;
exports.HookOptimizerService = HookOptimizerService = __decorate([
    (0, common_1.Injectable)()
], HookOptimizerService);
//# sourceMappingURL=hook-optimizer.service.js.map