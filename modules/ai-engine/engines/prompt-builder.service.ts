...
export interface MatchContext {
  ...
  events?: { type: string; minute: number; comment: string }[];
...
Answer in Chinese. Be concise. Cite specific data points.`;
  ...
  private buildPreMatchPrompt(context: MatchContext): string {
...
For the comprehensive score, assign attack, defense, midfield, and overall ratings to both teams.`;
  ...
  private buildPostMatchPrompt(context: MatchContext): string {
